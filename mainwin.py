...
class MainWin ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_button11.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		...
		self.m_button111.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		...
		self.m_button112.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		bSizer52.Add( self.m_button112, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_staticText42 = wx.StaticText( self, wx.ID_ANY, u"油泵启动", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button1121.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		bSizer521.Add( self.m_button1121, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_staticText421 = wx.StaticText( self, wx.ID_ANY, u"油泵启动", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button1122.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		bSizer522.Add( self.m_button1122, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_staticText422 = wx.StaticText( self, wx.ID_ANY, u"油泵启动", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button1123.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		bSizer523.Add( self.m_button1123, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_staticText423 = wx.StaticText( self, wx.ID_ANY, u"油泵启动", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button11211.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		bSizer5211.Add( self.m_button11211, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_staticText4211 = wx.StaticText( self, wx.ID_ANY, u"油泵启动", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_button11221.SetBitmap( wx.Bitmap( u"/Volumes/work/pywork/btn.png", wx.BITMAP_TYPE_ANY ) )
		bSizer5221.Add( self.m_button11221, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )

		self.m_staticText4221 = wx.StaticText( self, wx.ID_ANY, u"油泵启动", wx.DefaultPosition, wx.DefaultSize, 0 )
